...
#Serve a trovare la versione più recente del kernel installata,elenca tutti i file che iniziano con vmlinuz, elimina gli eventuali errori, rimuove la parte vmlinuz-, ordina i risultati e prende l'ultima riga.
